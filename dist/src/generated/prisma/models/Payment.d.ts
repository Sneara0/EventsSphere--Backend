...
export type PaymentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "transactionId" | "amount" | "currency" | "paymentStatus" | "paymentMethod" | "invoiceUrl" | "bookingId" | "userId" | "createdAt" | "updatedAt", ExtArgs["result"]["payment"]>;
