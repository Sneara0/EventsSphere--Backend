 ...
 */
const getMaxAge = (envValue, defaultValue) => {
    try {
...
const setBetterAuthSessionCookie = (res, sessionId) => {
    const maxAge = getMaxAge(process.env.REFRESH_TOKEN_EXPIRES_IN, '7d');
...
export const cookieUtils = {
    setCookie,
    getCookie: (req, key) => req.cookies[key],
    clearCookie: (res, key, options) => res.clearCookie(key, options),
