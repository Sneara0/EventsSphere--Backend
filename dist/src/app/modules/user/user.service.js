 ...
 */
const getAllUsersFromDB = async (role) => {
 ...
 */
const getMyProfileFromDB = async (userId, role) => {
    return await prisma.user.findUnique({
 ...
 */
const updateMyProfileIntoDB = async (userId, role, payload) => {
    ...
    return await prisma.$transaction(async (tx) => {
        ...
        if (image || profileImage)
            userUpdateData.image = image || profileImage;
        ...
        const relatedTableData = { ...otherData };
        if (phone) {
