 ...
 */
router.get("/me", checkAuth(Role.PARTICIPANT, Role.ORGANIZER, Role.ADMIN), UserController.getMyProfile);
/**
 * ২. Update My Profile
 * Access: Any Logged-in User
 */
router.patch("/update-profile", checkAuth(Role.PARTICIPANT, Role.ORGANIZER, Role.ADMIN), UserController.updateMyProfile);
/**
 ...
 */
router.get("/:id", checkAuth(Role.ADMIN, Role.ORGANIZER), UserController.getSingleUser);
/**
